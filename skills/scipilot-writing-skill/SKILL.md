...
description: >-
  SciPilot Skills 家族的学术论文写作与润色技能，覆盖中英互译润色、缩写/扩写、英文/中文表达润色、逻辑检查、去 AI 味、逐章节起草、图表标题、实验结果分析、cover letter 和 rebuttal。交付前运行 scripts/writing_lint.py 做机器自检，并叠加审稿人视角自审闭环。学术诚信红线：润色只动表达不动数值、方向或结论，不编造数据或引用。Stage 0 主动询问任务类型、文本载体、目标期刊或会议、语言方向、学科领域和修改保守度。触发词包括润色、polish、proofread、改写、中译英、英译中、condense、expand、去 AI 味、humanize、写摘要、写引言、draft abstract、caption、cover letter、rebuttal、response to reviewers，以及用户上传论文或段落并要求改善表达、语言、可读性或学术性。
license: MIT
---
