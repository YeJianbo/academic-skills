...
1. 确定论文的一句话主张：解决什么问题、在什么模型下、相比谁改进了什么。
...
5. 建立贡献-证据映射：每个贡献必须对应定义、定理、复杂度分析、实验、攻击评估或消融。
...
2. **Positioning**: 说明论文更像理论构造、协议系统、FL 隐私防御、攻击分析还是混合型工作。
3. **Narrative Spine**: 给出从问题到贡献的递进链条。
4. **Section Blueprint**: 列出章节/小节标题、每节任务、输入材料、预期输出。
5. **Evidence Map**: 把每个贡献映射到证明、实验、复杂度或攻击评估。
6. **Writing Queue**: 给出建议写作顺序，按章节/小节拆成可逐项完成的小任务。
